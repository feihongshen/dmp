...
//	// softwareSerialNo="0SDK-EMY-0130-XXXXX";//软件序列号,请通过亿美销售人员获取
...
//		try {
//			int i = SingletonClient.getClient().sendSMS(new String[] { "15000000000" }, "即时短信", "", 5);// 带扩展码
...
//
//	/**
//	 * 1、从EUCP平台接收手机用户上行的短信 2、返回值list中的每个元素为一个Mo对象 3、Mo具体数据结构参考使用手册
//	 */
