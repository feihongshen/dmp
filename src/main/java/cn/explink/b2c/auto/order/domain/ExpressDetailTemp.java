package cn.explink.b2c.auto.order.domain;
 ...
 *
 */
public class ExpressDetailTemp {
	
	private String tpsTransId;
	/**
	 * 运单号,快递单运单号
	 */
	...
	private String			cnorCorpNo;			// 寄件单位编码
	
	private String			cnorCorpName;		// 寄件单位名称
	
	private BigDecimal		freight;			// 应收运费
	
	private String			accountId;			// 月结帐号
	
	private BigDecimal		packingFee;			// 包装费
	
	private	String			expressImage;		// 图片url
	...
	public void setTpsTransId(String tpsTransId) {
		this.tpsTransId = tpsTransId;
	}
	...
	public String getCnorCorpNo() {
		return cnorCorpNo;
	}
	public void setCnorCorpNo(String cnorCorpNo) {
		this.cnorCorpNo = cnorCorpNo;
	}
	public String getCnorCorpName() {
		return cnorCorpName;
	}
	public void setCnorCorpName(String cnorCorpName) {
		this.cnorCorpName = cnorCorpName;
	}
