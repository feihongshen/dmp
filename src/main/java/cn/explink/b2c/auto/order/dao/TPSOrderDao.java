...
public class TPSOrderDao {
	...
	@SuppressWarnings("unused")
	private final class MQCwbOrderDTOMapper implements RowMapper<MQCwbOrderDTO> {
		@Override
		public MQCwbOrderDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
			MQCwbOrderDTO cwbOrder = new MQCwbOrderDTO();
