...
public class Mail {
	...
	private static final String sendemail = "352170177@qq.com";
	private static final String sendusername = "352170177";
	private static final String sendpassword = "1103400035";
	private static final String senddisplayname = "Explink-DMP Send  Exception Monitoring Center ";
	...
	public static Mail LoadingMessageParams(String exptContent) {
		Mail mm = null;
		String content = "您好，dmp处理一号店数据异常，" + exptContent;
		try {
			mm = new Mail("zhangpk@explink.cn", " 一号店数据异常", content, null);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return mm;
