...
public class B2CMonitorData {
	...
	private String send_b2c_flagStr;// 推送状态，0未推送，1.推送成功，2推送失败)
	private long customerid;
	private String expt_reason; // 异常原因
	private String remark; // 备注信息
	private int hand_deal_flag; // 客服处理备注 是否处理 0,未处理，1已处理
	private String hand_deal_flagStr; // 客服处理备注 是否处理 0,未处理，1已处理
	...
	public String getSend_b2c_flagStr() {
		if (send_b2c_flag == 0) {
			return "未推送";
		}
		if (send_b2c_flag == 1) {
	...
	public String getHand_deal_flagStr() {
		if (hand_deal_flag == 1) {
			return "已处理";
		} else {
			return "未处理";
