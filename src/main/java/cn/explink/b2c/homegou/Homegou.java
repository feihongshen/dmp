...
public class Homegou {
	...
	private String charencode = "UTF-8"; // 编码方式 //请求服务器编码
	private String readtxtCharcode; // 解析txt文件编码方式

	public String getReadtxtCharcode() {
		return readtxtCharcode;
	}

	public void setReadtxtCharcode(String readtxtCharcode) {
		this.readtxtCharcode = readtxtCharcode;
	}
	...
	private String customerid_tuihuo; // 上门退订单
