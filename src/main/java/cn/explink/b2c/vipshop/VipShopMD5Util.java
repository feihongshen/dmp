...
public class VipShopMD5Util {
	...
	public static String parseJonitMD5Str(Map<String, Object> parseXmlMap, String private_key) {
		String version = parseXmlMap.get("version") != null ? parseXmlMap.get("version").toString() : "";
		String response_time = parseXmlMap.get("response_time") != null ? parseXmlMap.get("response_time").toString() : "";
		String cust_code = parseXmlMap.get("cust_code") != null ? parseXmlMap.get("cust_code").toString() : "";
		String sys_response_code = parseXmlMap.get("sys_response_code") != null ? parseXmlMap.get("sys_response_code").toString() : "";
		String sys_response_msg = parseXmlMap.get("sys_response_msg") != null ? parseXmlMap.get("sys_response_msg").toString() : "";
