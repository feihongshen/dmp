...
public class OrderExportHeaderDto implements Serializable {
	...
	private String carrierShipmentCode = "";

	/** 单据类型 (orderType) */
	private String orderType = "";

	/** 应收款 (toCollectAmount) */
	private BigDecimal toCollectAmount = BigDecimal.ZERO;

	/** 应退款 (collectedAmount) */
	private BigDecimal collectedAmount = BigDecimal.ZERO;

	/** 送货物品金额 (deliveryProductAmount) */
	private BigDecimal deliveryProductAmount = BigDecimal.ZERO;

	/** 退货物品金额 (returnProductAmount) */
	private BigDecimal returnProductAmount = BigDecimal.ZERO;

	/** 重量(kg) (weight) */
	private BigDecimal weight = BigDecimal.ZERO;

	/** 箱数 (cartonQuantity) */
	private Long cartonQuantity = Long.parseLong("0");
