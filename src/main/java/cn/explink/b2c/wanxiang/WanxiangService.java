...
public class WanxiangService {
	...
	public void edit(HttpServletRequest request,int joint_num){
		...
		lt.setShangmentuiSupport(Integer.valueOf(request.getParameter("shangmentuiSupport")));
		lt.setJushousendflag(Integer.valueOf(request.getParameter("jushousendflag")));
