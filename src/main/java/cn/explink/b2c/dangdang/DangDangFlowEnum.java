...
public enum DangDangFlowEnum {
	Ruku(FlowOrderTypeEnum.RuKu.getValue(), "入库信息反馈"), FenZhanLingHuo(FlowOrderTypeEnum.FenZhanLingHuo.getValue(), "分站领货派送"), YiShenHe(FlowOrderTypeEnum.YiShenHe.getValue(), "已审核");
