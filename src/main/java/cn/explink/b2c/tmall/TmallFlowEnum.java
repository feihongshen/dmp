...
public enum TmallFlowEnum {
	TMS_ACCEPT("TMS_ACCEPT", FlowOrderTypeEnum.RuKu.getValue(), "入库信息反馈"), TMS_STATION_IN("TMS_STATION_IN", FlowOrderTypeEnum.FenZhanDaoHuoSaoMiao.getValue(), "分站进"), TMS_DELIVERING("TMS_DELIVERING",
			FlowOrderTypeEnum.FenZhanLingHuo.getValue(), "分站派送"),
