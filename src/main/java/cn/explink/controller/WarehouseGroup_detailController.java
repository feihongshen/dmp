		...
		// 武汉飞远运输交接单 add by chunlei05.li 2016/8/11
			...
			for (CwbOrder cwb : cwbList) {
				...
				if (vo == null) {
					...
					vo.setOutstockStartTime(strtime);
...
//		return str.substring(0, str.length() - 1);
	...
	public String outbillprinting_history(Model model, @PathVariable("outwarehousegroupid") long outwarehousegroupid,
		...
		Branch branch = this.branchDAO.getBranchByBranchid(this.outwarehousegroupDao.getOutWarehouseGroupByid(outwarehousegroupid).getBranchid());
