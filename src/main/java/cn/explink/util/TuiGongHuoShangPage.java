...
@Component
public class TuiGongHuoShangPage {

	public static final int ONE_PAGE_NUMBER = 100;//原来的Page类,pageSize默认为10,被其他部分使用,
//	现在需求要 客户收退货确认  的pageSize为100,所以单独新建一个。
	public static final int EXCEL_PAGE_NUMBER = 150000;
	public static final int DETAIL_PAGE_NUMBER = 1000;
	 ...
	 */
	public TuiGongHuoShangPage() {

	}

	public TuiGongHuoShangPage(String sql) {
	 ...
	 *            每页记录数
	 */
	public TuiGongHuoShangPage(long total, long currentPage, long pagenum) {
