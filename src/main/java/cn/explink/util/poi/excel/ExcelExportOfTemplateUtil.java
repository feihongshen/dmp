...
public final class ExcelExportOfTemplateUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(ExcelExportOfTemplateUtil.class);
	...
	private static Object getCellValue(ExcelExportEntity entity, Object obj) throws Exception {
		Object value = entity.getGetMethods() != null ? ExcelExportOfTemplateUtil.getFieldBySomeMethod(entity.getGetMethods(), obj) : entity.getGetMethod().invoke(obj, new Object[] {});
	...
	private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row, int i, String field, Object obj, Workbook workbook) throws Exception {
		...
		if (entity.getExportImageType() == 1) {
			...
			byte[] value = (byte[]) (entity.getGetMethods() != null ? ExcelExportOfTemplateUtil.getFieldBySomeMethod(entity.getGetMethods(), obj) : entity.getGetMethod().invoke(obj, new Object[] {}));
			if (value != null) {
