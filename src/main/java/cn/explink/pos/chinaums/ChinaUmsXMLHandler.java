...
public class ChinaUmsXMLHandler {
	 ...
	 * @return String
	 */
	public static String createMACXML_Login(Map loginmap, EmployeeInfo user) {
		StringBuffer str = new StringBuffer("");
	 ...
	 * @return String
	 */
	public static String createXMLMessage_Login(Map loginmap, EmployeeInfo user, String resp_code) {
		StringBuffer str = new StringBuffer("");
	 ...
	 * @return String
	 */
	public static String createMACXML_SearchCwb(Map cwbmap, ChinaUmsRespNote chinaUmsRespNote) {
		StringBuffer str = new StringBuffer("");
	 ...
	 */
	public static String createXMLMessage_SearchCwb(Map cwbmap, ChinaUmsRespNote chinaUmsRespNote) {
		StringBuffer str = new StringBuffer("");
		if (chinaUmsRespNote != null && chinaUmsRespNote.getCwbOrder() != null) {
