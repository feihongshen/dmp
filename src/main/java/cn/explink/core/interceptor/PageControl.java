...
package cn.explink.core.interceptor;
...
public class PageControl {
     ...
     * @param isGetCount
     */
    public static void performPage(Pager pager) {
        pager.setCurPage(pager.getCurPage());
        pager.setItemsPerPage(pager.getItemsPerPage());
        GET_ITEMS_TOTAL.set(true);
        LOCAL_PAGER.set(pager);
    }
