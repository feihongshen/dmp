...
public enum ExceptionCwbErrorTypeEnum {
	...
	DaizhongzhuanshenheCannotlinghuo(131, "待中转审核的订单不允许领货"), ShenhetongguoCannotlinghuo(132, "审核通过的订单不允许领货"), Tuihuoquerensuccess(133, "审核确认退货的订单不可以进行领货操作！！"), DaizhongzhuanCannotlinghuo(134,
			...
			FEI_PEI_SONG_BANG_DING_EMS_TRANS(221,"非配送单不允许绑定邮政运单号！"),
			BU_SHI_GAI_PEI_SONG_ZHAN_EMS_CWB(222,"订单目的站点不是邮政站点！"),
			...
			VipShangmenhuanLantuiWeidaohuo(236, "唯品会上门换业务配送单关联的揽退单未到货！"),
			VipShangmenhuanLantuiFeilantui(236, "唯品会上门换业务配送单关联的订单不是揽退单！");
