...
public enum ReasonTypeEnum {
	...
	"未刷卡原因"), DiuShi(9, "丢失原因"), WeiTuiShangPin(10, "未退商品原因"), TuiHuoZhanRuKuBeiZhu(11, "退货站入库备注"), ShiXiaoReason(12, "失效原因"), GongDanTouSuYuanYin(13, "工单投诉原因"), KeHuLeiXing(14, "客户类型"), Intercept(
			15, "拦截原因");
