 ...
 */
public class DeliverPaymentReportVo {
	/**
	 * 小件员ID
	 */
	...
	public String toString() {
		return "DeliverPaymentPrintVo [deliveryId=" + deliveryId + ", deliveryName=" + deliveryName
				+ ", deliveryPaymentPatternId=" + deliveryPaymentPatternId + ", deliveryPaymentPattern="
				+ deliveryPaymentPattern + ", customerId=" + customerId + ", customerName=" + customerName
				+ ", cwbOrderTypeId=" + cwbOrderTypeId + ", cwbOrderType=" + cwbOrderType + ", orderCount=" + orderCount
				+ ", shouldReceivedfee=" + shouldReceivedfee + ", shouldPaybackfee=" + shouldPaybackfee
				+ ", shouldfare=" + shouldfare + ", shouldTotal=" + shouldTotal + ", realTotal=" + realTotal + "]";
	}
}
