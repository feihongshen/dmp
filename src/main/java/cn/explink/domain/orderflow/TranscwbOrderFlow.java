...
public class TranscwbOrderFlow implements Serializable  {
	...
	public TranscwbOrderFlow() {
	}

	public TranscwbOrderFlow(int floworderid, String cwb, String scancwb, long branchid, Timestamp credate, long userid, String floworderdetail, int flowordertype, String comment) {
