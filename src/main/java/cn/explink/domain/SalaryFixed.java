...
/**
 * @return the bonusfuel
 */
public BigDecimal getBonusfuel() {
	return this.bonusfuel;
}
/**
 * @param bonusfuel the bonusfuel to set
 */
public void setBonusfuel(BigDecimal bonusfuel) {
	this.bonusfuel = bonusfuel;
}
/**
