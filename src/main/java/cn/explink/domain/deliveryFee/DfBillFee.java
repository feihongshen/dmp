...
public class DfBillFee {
    ...
    private String cwbprovince;
    private String cwbcity;
    private String cwbcounty;
...
//    private DfPriceRule<DfBillFee> finalRule;
    ...
    public int getIsCalculted() {
        return isCalculted;
    }

    public void setIsCalculted(int isCalculted) {
        this.isCalculted = isCalculted;
    }
    ...
    public void setFeeCreateUser(String feeCreateUser) {
    ...
    public String getFeeUpdateUser() {
        return feeUpdateUser;
    }

    public void setFeeUpdateUser(String feeUpdateUser) {
        this.feeUpdateUser = feeUpdateUser;
    }

    public long getJiamengPieces() {
        if (this.getCwbordertypeid() == OrderTypeEnum.TuiHuo.getValue())
            return this.getBackcarnum();
        else
            return this.getSendcarnum();
    }
