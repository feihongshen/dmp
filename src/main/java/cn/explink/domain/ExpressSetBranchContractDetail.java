...
/**
 * express_set_branch_contract_detail 实体类 
 * Tue Jun 16 18:49:13 CST 2015 
 * Li ChongChong
 */

public class ExpressSetBranchContractDetail {
	private int id;
	...
	public ExpressSetBranchContractDetail() {

	}

	public ExpressSetBranchContractDetail(int id, int branchId,
