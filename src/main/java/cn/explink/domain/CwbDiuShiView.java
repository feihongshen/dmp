...
@XmlRootElement
public class CwbDiuShiView {

	private static Logger logger =LoggerFactory.getLogger(CwbDiuShiView.class);
	...
	private long diushiid;// 货物丢失处理表id
	...
	public long getShenheRole() {
		return shenheRole;
	}

	public void setShenheRole(long shenheRole) {
		this.shenheRole = shenheRole;
	}

	public long getDiushiid() {
		return diushiid;
	}

	public void setDiushiid(long diushiid) {
		this.diushiid = diushiid;
	}
