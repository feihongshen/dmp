...
//		}
	...
	public void updateypdjflowordertype(String cwb){
		String sql="update ops_ypdjhandlerecord set flowordertype="+FlowOrderTypeEnum.FenZhanLingHuo.getValue()+" where cwb='"+cwb+"'";
