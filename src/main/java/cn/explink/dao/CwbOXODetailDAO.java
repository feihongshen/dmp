...
public class CwbOXODetailDAO {
	...
	public List<CwbOXODetailBean> getCwbOXODetailByPage(long page, long currentBranchId,
		...
		String sql =  "SElECT '"+cwbOXOStateText+"' as cwbstate, cwb.cwb,cus.customername,date_format(cwb.credate,'%Y-%m-%d %H:%i:%s') as credate,cwb.receivablefee,bra.branchname,pay.payway "
				     ...
				     + "    ((  SELECT "+OXOTypePick+" as deliverytypeid,cwbordertypeid,cwb,customerid,credate,receivablefee,deliverybranchid,paywayid,pickbranchid,oxopickstate,oxodeliverystate FROM express_ops_cwb_detail WHERE cwbordertypeid = "+OXOJITValue+") "
                            +"  UNION"
                            ...
                            +      "LEFT JOIN" 
                            +      "(SELECT cwbordertypeid,cwb,customerid,credate,receivablefee,deliverybranchid,paywayid,pickbranchid,oxopickstate,oxodeliverystate FROM express_ops_cwb_detail WHERE cwbordertypeid = "+OXOValue+") b "
