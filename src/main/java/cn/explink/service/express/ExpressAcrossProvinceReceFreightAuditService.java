...
import cn.explink.dao.express.ExpressAcrossProvinceReceFreightAuditDao;
 ...
 */
@Service
public class ExpressAcrossProvinceReceFreightAuditService {
	@Autowired
	ExpressAcrossProvinceReceFreightAuditDao expressAcrossProvinceFreightAudit;
	@Autowired
	CwbDAO cwbDao;
	@Autowired
