...
public class EmbracedOrderInputService extends ExpressCommonService {
	...
	public synchronized String savaEmbracedOrderVO(EmbracedOrderVO embracedOrderVO, int flags) {
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getSender_provinceid()) && !"null".equals(embracedOrderVO.getSender_provinceid().trim()) ){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getSender_cityid()) && !"null".equals(embracedOrderVO.getSender_cityid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getConsignee_provinceid())  && !"null".equals(embracedOrderVO.getConsignee_provinceid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getConsignee_cityid()) && !"null".equals(embracedOrderVO.getConsignee_cityid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getSender_countyid()) && !"null".equals(embracedOrderVO.getSender_countyid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getSender_townid()) && !"null".equals(embracedOrderVO.getSender_townid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getConsignee_countyid()) && !"null".equals(embracedOrderVO.getConsignee_countyid().trim())){
		...
		if(StringUtils.isNotBlank(embracedOrderVO.getConsignee_townid())  && !"null".equals(embracedOrderVO.getConsignee_townid().trim())){
		...
		if ((flags == 0) || (flags == 2)) {
			...
			System.out.println("补录：update方法，补录标志位：" + embracedOrderVO.getIsadditionflag());
