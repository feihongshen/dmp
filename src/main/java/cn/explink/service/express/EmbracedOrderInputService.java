	...
	public void tpsSender(EmbracedOrderVO embracedOrderVO, String inputOrEmbrace) {
		if (StringUtils.isBlank(inputOrEmbrace) || !("input".equals(inputOrEmbrace) || "inbrace".equals(inputOrEmbrace))) {
			...
			try {
				...
				String address = StringUtil.nullConvertToEmptyString(embracedOrderVO.getConsignee_provinceName()) + 
						StringUtil.nullConvertToEmptyString(embracedOrderVO.getConsignee_cityName()) + 
						StringUtil.nullConvertToEmptyString(embracedOrderVO.getConsignee_countyName()) + 
						StringUtil.nullConvertToEmptyString(embracedOrderVO.getConsignee_townName()) + 
						StringUtil.nullConvertToEmptyString(embracedOrderVO.getConsignee_adress());
