			...
			<div class="right_title" style="overflow: auto; height: 100%; margin-top: 10px">
				<table id="table1" width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2">
					<tr class="font_1">
						...
						<td align="center" valign="middle" bgcolor="#eef6ff">订单类别</td>
						...
						<td align="center" valign="middle" bgcolor="#eef6ff">退货/中转入库时间</td>
						<td align="center" valign="middle" bgcolor="#eef6ff">退货/中转原因</td>
					...
					<tr>
						...
						<td align="center" valign="middle">
							<%
								out.print(FlowOrderTypeEnum.getText(pv.getFlowordertype()).getText());
							%>
						</td>
