...
<div class="right_box">
	...
	<form id="searchForm2" action ="<%=request.getContextPath()%>/warehouseLog/exportExcel" method = "post" > 
	...
	<form id="searchForm1" action ="<%=request.getContextPath()%>/warehouseLog/nowlog" method = "post">
    ...
    <%} %>
		...
		<form  id="searchForm" action="<%=request.getContextPath()%>/warehouseLog/show/<%=request.getAttribute("customerid")==null?"":request.getAttribute("customerid")%>/<%=request.getAttribute("type")==null?"":request.getAttribute("type")%>/<%=request.getAttribute("count")==null?0:request.getAttribute("count")%>/1">
