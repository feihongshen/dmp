...
<div class="inputselect_box" style="top: 0px; ">
    ...
    <form id="searchForm" action ="<%=request.getContextPath()%>/logtoday/todayArrivalAll" method = "post">
        ...
        <div class="right_title">
        	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table4">
        		<tbody>
        			...
        			<tr height="30">
        				<%-- <td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_jinriyichuku/1"><%=todayArrival.getJinriyichuku()%></a></strong></td> --%>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_weidaohuo/1"><%=todayArrival.getWeidaohuo() %></a></strong></td>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_yidaohuo/1"><%=todayArrival.getYidaohuo() %></a></strong></td>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_lousaoyidaohuo/1"><%=todayArrival.getJinri_lousaodaozhan() %></a></strong></td>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_tazhandaohuo/1"><%=todayArrival.getTazhandaohuo() %></a></strong></td>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_shaohuo/1"><%=todayArrival.getShaohuo() %></a></strong></td>
        				<td align="center" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/daohuo_daocuohuo/1"><%=todayArrival.getDaocuohuo() %></a></strong></td>
        				</tr>
        			</tbody>
        		</table>
        </div>
                    ...
                    <tbody>
					 <tr class="font_1" height="30">
                        ...
                        <tr height="30">
                            ...
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_daohuo/1"><%=todayDelivery.getToday_fankui_daohuo() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            ...
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_daozhanweiling/1"><%=todayDelivery.getToudi_daozhanweiling() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/zuori_fankui_leijizhiliu/1"><%=todayDelivery.getZuori_fankui_leijizhiliu() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_linghuo/1"><%=todayDelivery.getToday_fankui_linghuo() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <%=todayStock.getZuori_weiguiban_kuicun() %></strong></td>
                            <td align="center" valign="middle"><strong>
                           <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_peisongcheng/1"><%=todayDelivery.getToday_fankui_peisongchenggong_count() %></a></strong></td>
                            
                            <td align="right" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_peisongcheng/1"><%=todayDelivery.getToday_fankui_peisongchenggong_money() %></a></strong></td>
                            <td colspan="4" align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_jushou/1"><%=todayDelivery.getToday_fankui_jushou() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_jinrizhiliu/1"><%=todayDelivery.getToday_fankui_leijizhiliu() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_bufenjushou/1"><%=todayDelivery.getToday_fankui_bufenjushou() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_zhongzhuan/1"><%=todayDelivery.getToday_fankui_zhobgzhuan() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_shangmentuichenggong/1"><%=todayDelivery.getToday_fankui_shangmentuichenggong_count() %></a></strong></td>
                            <td align="right" valign="middle"><strong>
                            <%=todayDelivery.getToday_fankui_shangmentuichenggong_money() %></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_shangmentuijutui/1"><%=todayDelivery.getToday_fankui_shangmentuijutui() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_shangmenhuanchenggong/1"><%=todayDelivery.getToday_fankui_shangmenhuanchenggong_count() %></a></strong></td>
                            <td align="right" valign="middle"><strong>
                            ...
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_shangmenhuanjuhuan/1"><%=todayDelivery.getToday_fankui_shangmenhuanjuhuan() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_diushi/1"><%=todayDelivery.getToday_fankui_diushi() %></a></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_fankuiheji/1"><%=todayDelivery.getToday_fankui_heji_count() %></a></strong></td>
                            <td align="right" valign="middle"><strong>
                            <%=todayDelivery.getToday_fankui_heji_yingshou_money() %></strong></td>
                            <td align="right" valign="middle"><strong>
                            <%=todayDelivery.getToday_fankui_heji_yingtui_money() %></strong></td>
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_weifankuiheji/1"><%=todayDelivery.getToday_weifankui_heji_count() %></a></strong></td>
                            <td align="right" valign="middle"><strong>
                            ...
                            <td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_fankuiweiguiban_heji/1"><%=todayDelivery.getToday_fankuiweiguiban_heji_count() %></a></strong></td>
                            <td align="right" valign="middle"><strong>
		  	...
		  	<div class="right_title">
		  		<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
		  			<tbody>
		  				...
		  				<tr height="30">
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_peisongchenggong/1"><%=todayFunds.getPeisongchenggong() %></a></strong></td>
		  					...
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_shangmentui/1"><%=todayFunds.getShangmentuichenggong() %></a></strong></td>
		  					<td align="right" valign="middle"><strong><%=todayFunds.getShangmentuichenggong_cash_amount() %></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_shangmenhuan/1"><%=todayFunds.getShangmenhuanchenggong() %></a></strong></td>
		  					...
		  					<td align="right" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_shijiaokuan/1"><%=todayFunds.getShijiaokuan_cash_amount() %></a></strong></td>
		  					<td align="right" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_shijiaokuan/1"><%=todayFunds.getShijiaokuan_pos_amount() %></a></strong></td>
		  					<td align="right" valign="middle"><strong><a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kuanxiang_shijiaokuan/1"><%=todayFunds.getShijiaokuan_checkfee_amount() %></a></strong></td>
	  					</tr>
	  				</tbody>
	  			</table>
		  	</div>
		  		...
		  		<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table3">
		  			<tbody>
		  				...
		  				<tr class="font_1" height="30">
		  					...
		  					<%=todayStock.getZuori_weiguiban_kuicun() %></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kucun_daohuo/1"><%=todayStock.getJinridaohuo() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kucun_tuotou/1"><%=todayStock.getJinrituodou() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kucun_tuihuochuku/1"><%=todayStock.getJinrituihuochuku() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/kucun_zhongzhuanchuku/1"><%=todayStock.getJinrizhongzhuanchuku() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_daozhanweiling/1"><%=todayDelivery.getToudi_daozhanweiling() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/jushou_kuicun/1"><%=todayStock.getJushou_kuicun() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/zhiliu_kuicun/1"><%=todayStock.getZhiliu_kuicun() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
		  					<a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/weiguiban_kuicun/1"><%=todayStock.getWeiguiban_kuicun() %></a></strong></td>
		  					<td align="center" valign="middle"><strong>
                            <a href="<%=request.getContextPath()%>/logtoday/showAll/<%=nowbranch.getBranchid() %>/toudi_diushi/1"><%=todayDelivery.getToday_fankui_diushi() %></a></strong></td>
	  					</tr>
	  				</tbody>
