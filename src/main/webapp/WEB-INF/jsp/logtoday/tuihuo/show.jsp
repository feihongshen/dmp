...
<div class="right_box">
	...
	<form id="searchForm2" action ="<%=request.getContextPath()%>/tuihuoLog/exportExcel" method = "post" > 
	...
	<form id="searchForm1" action ="<%=request.getContextPath()%>/tuihuoLog/nowlog" method = "post">
    ...
    <%} %>
		...
		<form  id="searchForm" action="<%=request.getContextPath()%>/tuihuoLog/show/<%=request.getAttribute("type")==null?"":request.getAttribute("type")%>/1">
		</form>	
	<div class="jg_10"></div>
