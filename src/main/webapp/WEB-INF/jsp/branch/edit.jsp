...
<div id="box_contant">
	...
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>修改机构</h1>
		...
		<div id="box_form">
			 ...
			 <%=BranchEnum.CaiWu.getValue()%>)">
           		...
           		<li><span>机构名称：</span><input type="text" name="branchname" id="branchname" value ="<%=branch.getBranchname() %>" maxlength="50"/>*</li>
           		<li><span>机构编号：</span><input type="text" name="branchcode" id="branchcode" value ="<%=branch.getBranchcode() %>" maxlength="50"/>*</li>
		        <li><span>负 责 人：</span><input type="text" name="branchcontactman" id="branchcontactman" value ="<%=branch.getBranchcontactman() %>" maxlength="50"/>*</li>
		        <li><span>固定电话：</span><input type="text" name="branchphone" id="branchphone" value ="<%=branch.getBranchphone()%>" maxlength="50"/></li>
			    <li><span>省份：</span><input type="text" name="branchprovince" id="branchprovince" value ="<%=branch.getBranchprovince()%>" maxlength="50"/></li>
			    <li><span>城市：</span><input type="text" name="branchcity" id="branchcity" value ="<%=branch.getBranchcity()%>" maxlength="50"/></li>
			    <li><span>区/县：</span><input type="text" name="brancharea" id="brancharea" value ="<%=branch.getBrancharea()%>" maxlength="50"/></li>
			    <li><span>乡镇/街道：</span><input type="text" name="branchstreet" id="branchstreet" value ="<%=branch.getBranchstreet()%>" maxlength="50"/></li>
			    <li><span>地址：</span><input type="text" name="branchaddress" id="branchaddress" value ="<%=branch.getBranchaddress()==null?"":(branch.getBranchaddress().length()>0?branch.getBranchaddress().replace("\"", "&quot;"):branch.getBranchaddress())%>" maxlength="50"/></li>
			   <%--  <li><span>所属区域：</span><select name="accountarea" id="accountarea">
				 ...
				 <li><span>站点手机：</span><input type="text" name="branchmobile" id="branchmobile" value ="<%=branch.getBranchmobile()%>" maxlength="50"/></li>
				 <li><span>邮箱：</span><input type="text" name="branchemail" id="branchemail" value ="<%=branch.getBranchemail()%>" maxlength="50"/></li>
