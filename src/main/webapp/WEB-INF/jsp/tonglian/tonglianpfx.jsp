...
$(function(){
	uploadFormTonglianInit('pfxPath','<%=request.getParameter("fromAction") %>','upbutton','<%=request.getContextPath()%>');
	$("#pfxPath").val(<%=request.getParameter("pfxPath") %>);
});
</script>
</head>
...
<div style="position:absolute; z-index:9; left:0; top:0px; bottom:0px">
	<input type="text" id="pfxPath" name="pfxPath" style="border: solid 1px;  background-color: #FFFFFF;" disabled="disabled"/>
</div>
