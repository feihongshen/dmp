...
<div class="right_box">
  <div class="right_title">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="table_2">
	   ...
	   <%if(fa==null){ %>
	    <tr height="30" >
	   		<td width="50%" align="center" valign="middle" colspan="2">${error}</td>
		</tr>
	   <%}else{ %>
		<tr height="30" >
		...
		<tr>
			...
			<td align="left" valign="middle"><label for="textfield2"><strong><%=fa.getPayqiankuanamount() %></strong>元</label></td>
		  </tr>
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="0" class="table_5">
	  <tr>
	    <th scope="col"><input name="button2" onclick="location.href='<%=request.getContextPath()%>/funds/financeChargeList/1'" type="button" class="input_button1" id="button2" value="返回"></th>
	  </tr>
	</table>
