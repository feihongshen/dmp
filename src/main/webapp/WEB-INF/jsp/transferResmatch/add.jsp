...
<div id="box_contant">
	...
	<div id="box_top_bg"></div>
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>创建中转原因匹配</h1>
		<form id="exptcode_Form" name="exptcode_Form"  onSubmit="if(check_transferResasonMatch()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/transferReason/create/" method="post">
		<div id="box_form">
				<ul>
					<li><span>固定中转原因：</span>
						<select name ="transferReasonid" id="transferReasonid" >
				             ...
				             %>
				             <option value="<%=ts.getId()%>"><%=ts.getReasonname()%></option>
				              <%}%>
