...
<div class="right_box">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
	  <tr class="font_1">
			<td width="35%" align="center" valign="middle" bgcolor="#eef6ff">问题件类型</td>
			<td width="35%" align="center" valign="middle" bgcolor="#eef6ff">操作</td>
		</tr>
		 <% for(AbnormalType abnormalType : abnormalTypeList){ %>
		<tr>
			<td width="35%" align="center" valign="middle"><%=abnormalType.getName() %></td>
			<td width="35%" align="center" valign="middle">
			[<a href="javascript:del(<%=abnormalType.getId() %>);"><%=(abnormalType.getState()==1?"停用":"启用") %></a>]
			[<a href="javascript:edit_button(<%=abnormalType.getId() %>);">修改</a>] 
			</td>
		</tr>
		<%} %>
	</table>
...
<!-- 创建问题件类型的ajax地址 -->
<input type="hidden" id="add" value="<%=request.getContextPath()%>/abnormalType/add" />
<!-- 修改问题件类型的ajax地址 -->
<input type="hidden" id="edit" value="<%=request.getContextPath()%>/abnormalType/edit/" />
<!-- 删除问题件类型的ajax地址 -->
<input type="hidden" id="del" value="<%=request.getContextPath()%>/abnormalType/del/" />
</body>
</html>
