						...
						<table width="100%" border="0" cellspacing="10" cellpadding="0" style="font-size:14px;">
							<tbody>
								<tr class="font_1">
									...
									运单号：<strong><%=view.getCwb() %></strong>&nbsp;&nbsp;
									运单号当前状态：<strong><%if(view.getFlowordertypeMethod()=="已审核"){%>审核为：<%=view.getDeliveryStateText() %><%}else if(view.getFlowordertypeMethod()=="已反馈") {%>反馈为：<%=view.getDeliveryStateText() %><%}else{ %><%=view.getFlowordertypeMethod() %><%} %></strong>
									<table width="100%" border="0" cellspacing="0" cellpadding="2" class="table_5"  style="font-size:14px;">
											<tr>
												<td width="150px;" align="center" bgcolor="#f1f1f1">操作时间</td>
												<td width="100px;" align="center" bgcolor="#f1f1f1">操作员</td>
