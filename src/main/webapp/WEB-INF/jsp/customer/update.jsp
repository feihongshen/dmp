...
<input type="text" id="wavText" name="wavText" style="border: solid 1px; background-color: #FFFFFF;" disabled="disabled" value="<%=new String((request.getParameter("wavFilePath")).getBytes("ISO-8859-1"),"UTF-8")%>"/>
</div>
<div style="position:absolute; z-index:9; left:154px; top:0px">
<input type="button" id="upbutton" class="button" />
</div></label>
</body>
</html>