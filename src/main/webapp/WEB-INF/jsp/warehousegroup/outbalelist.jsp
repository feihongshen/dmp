...
function bdprint(){
	...
	if(isprint==""){
		...
		$("#selectforsmtbdprintForm").attr("action","<%=request.getContextPath() %>/warehousegroupdetail/outbalelist_print");
	...
	<div class="inputselect_box">
		      ...
		      &nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" onclick="bdprint();" value="打印" class="input_button2" />
				      <a href="<%=request.getContextPath() %>/warehousegroupdetail/outbalelist_history/1">历史打印列表>></a>
				</form>
				</div>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
					<tr class="font_1">
						...
						<td width="25%" align="center" valign="middle" bgcolor="#eef6ff">包号(批次号)</td>
						<td width="25%" align="center" valign="middle" bgcolor="#eef6ff">出库库房</td>
						<td width="25%" align="center" valign="middle" bgcolor="#eef6ff">下一站</td>
