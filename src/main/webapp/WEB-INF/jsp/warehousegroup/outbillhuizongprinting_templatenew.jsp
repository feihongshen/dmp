		...
		<div class="Section0" style="layout-grid: 15.6000pt;">
			<table  border="1" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td colspan="5"><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt; font-size: 9.5000pt;"><%=localbranchname %> - <%for(Branch b : branchlist){if(branchid==b.getBranchid()){%><%=b.getBranchname() %><%}} %><span
