...
<div class="right_box">
	<div class="inputselect_box">
				...
				<form action="1" method="post" id="searchForm">
				           操作时间：从<input type ="text" name ="beginemaildate"  class="input_text1" id ="beginemaildate" value ="<%=StringUtil.nullConvertToEmptyString(request.getParameter("beginemaildate")) %>"/>&nbsp;到
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
					 ...
					 <tr>
						...
						<td width="25%" align="center" valign="middle" >
							<a href ="../changebillprinting_default/<%=og.getId()%>">中转出站交接单打印</a>
