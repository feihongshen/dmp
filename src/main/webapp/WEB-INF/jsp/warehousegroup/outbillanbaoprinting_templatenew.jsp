	...
	<tr>
		<td colspan="6" style="border-top-style: solid;border-top-color: black;border-top-width: 1px"><table  border="0" cellspacing="0" cellpadding="0">
			...
			<%for(int i=0;i<printList.size();i++){ %>
				<tr>
					<td width="55px" style="font-size: 9.5000pt;"><%=i+1 %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getCwb() %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getDanshu() %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getJianshu() %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getCarrealweight() %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getChengzhong() %></td>
					<td style="font-size: 9.5000pt;" ><%=printList.get(i).getCwbremark() %></td>
				</tr>
