					...
					<td>
						<table width="100%" border="1" cellspacing="0" cellpadding="5" class="table1">
							<tr>
								...
								<div style="float:right; width:200px; line-height:20px">&nbsp;<%=co.getEmaildate().substring(0, 10) %>&nbsp;山西誉美捷
							...
							<tr>
								...
								<td colspan="2" align="center" >
									<p style="line-height: 12px;"><%=co.getConsigneeaddress() %>&nbsp;&nbsp;邮编：<%=co.getConsigneepostcode() %></p>
									<p style="line-height: 12px;">客户：<%=co.getConsigneename() %>&nbsp;&nbsp;电话：<%=co.getConsigneemobile().length()==0?co.getConsigneephone():co.getConsigneemobile() %></p>
								</td>
							</tr>
							<tr>
						...
						<table width="100%" border="1" cellspacing="0" cellpadding="5" class="table2">
							...
							<tr>
								<td style="line-height: 10px;">客户：<%=co.getConsigneename().split(" ")[0] %>&nbsp;电话：<%=co.getConsigneemobile().length()==0?co.getConsigneephone():co.getConsigneemobile() %></td>
								<td>应收金额：<%=co.getReceivablefee() %>元</td>
							</tr>
							<tr>
								<td style="padding: 1px 0;">
									<p style="line-height: 12px;">网址：www.5668811.cn</p>
									<p>客服电话：0351-5668811</p>
								</td>
								<td rowspan="2" style="line-height: 10px;">保留此单包裹单底代表您已经签收并认可我们的服务，如有任何疑问可联系客服咨询。</td>
							</tr>
							<tr>
								<td>山西誉美捷：www.5668811.cn</td>
							</tr>
						</table>
