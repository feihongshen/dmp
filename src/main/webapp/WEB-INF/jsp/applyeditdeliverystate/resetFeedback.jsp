...
<form id="searchForm" action ="<%=request.getContextPath()%>/applyeditdeliverystate/resetFeedback" method = "post">
		<div class="kfsh_tabbtn">
			<ul>
				<li><a href="<%=request.getContextPath()%>/applyeditdeliverystate/resetFeedback" class="light">重置反馈</a></li>
				<li><a href="<%=request.getContextPath()%>/applyeditdeliverystate/resetFeedbackList">重置反馈列表</a></li>
			</ul>
		</div>
<table>
	<tr>
