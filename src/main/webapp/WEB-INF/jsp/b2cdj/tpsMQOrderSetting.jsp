...
Object idStr = request.getAttribute("joint_num");
int id = 0;
if(idStr!=null){
	try{
		id = Integer.valueOf(idStr.toString());
	}catch(Exception e){
		
	}
}
String tpsName = B2cEnum.getEnumByKey(id) == null ? "" : B2cEnum.getEnumByKey(id).getText();
%>
...
<div id="box_contant">
    ...
    <div id="box_in_bg" style="width: 500px;">
        <h1><div id="close_box" onclick="closeBox()"></div><%=tpsName%>接口设置</h1>
