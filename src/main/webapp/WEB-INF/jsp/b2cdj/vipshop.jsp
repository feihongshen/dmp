...
<div id="box_contant">
	...
	<div id="box_in_bg" style="width: 500px;">
		<h1><div id="close_box" onclick="closeBox()"></div>唯品会对接设置</h1>
...
<div id="box_form">
				<ul>
					<%if(vipshop != null){ %>
						...
						<li><span>托运模式：</span>
							<input type ="radio" id="isTuoYunDanFlag1" name ="isTuoYunDanFlag" value="1" <%if(vipshop.getIsTuoYunDanFlag()==1){%>checked<%}%>  >开启
							<input type ="radio" id="isTuoYunDanFlag2" name ="isTuoYunDanFlag" value="0"   <%if(vipshop.getIsTuoYunDanFlag()==0){%>checked<%}%>  >关闭
						</li>
						<li><span>业务标识：</span>
							<input type ="radio" id="isShangmentuiFlag1" name ="isShangmentuiFlag" value="0" <%if(vipshop.getIsShangmentuiFlag()==0){%>checked<%}%>  >配送
					...
					<%}else{ %>
						...
						<li><span>托运模式：</span>
							<input type ="radio" id="isTuoYunDanFlag1" name ="isTuoYunDanFlag" value="1" checked >开启
							<input type ="radio" id="isTuoYunDanFlag2" name ="isTuoYunDanFlag" value="0"   >关闭
						</li>
