...
<%@page import="cn.explink.b2c.liantong.*"%>
<%@page import="cn.explink.domain.Branch"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
	Liantong lt = (Liantong)request.getAttribute("liantongObject");
...
<div id="box_contant">
	...
	<div id="box_in_bg">
		...
		<form id="smile_save_Form" name="smile_save_Form"  onSubmit="if(check_liebo()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/liantong/save/${joint_num}" method="post">
		<div id="box_form">
				<ul>
					<%if(lt != null){ %>
						...
						<li><span>wlcompanycode：</span>
	 						<input type ="text" id="appcode" name ="appcode"  maxlength="300" size="15" value="<%=lt.getAppcode()%>"  > 
						</li>
						<li><span>平台密钥：</span>
	 						<input type ="text" id="appsecret" name ="appsecret"  maxlength="300" size="15" value="<%=lt.getAppsecret()%>"  > 
						</li>
						<li><span>signSecurity：</span>
	 						<input type ="text" id="signSecurity" name ="signSecurity"  maxlength="300" size="15" value="<%=lt.getSignSecurity()%>"  > 
						</li>
						<li><span>Appkey：</span>
	 						<input type ="text" id="appkey" name ="appkey"  maxlength="300" size="15" value="<%=lt.getAppkey()%>"  > 
						</li>
						<li><span>调用方法：</span>
	 						<input type ="text" id="method" name ="method"  maxlength="300" size="15" value="<%=lt.getMethod()%>"  > 
						</li>
						<li><span>每次查询大小：</span>
					...
					<%}else{ %>
						...
						<li><span>wlcompanycode：</span>
	 						<input type ="text" id="appcode" name ="appcode"  maxlength="300" size="15" value=""  > 
						</li>
						<li><span>平台密钥：</span>
	 						<input type ="text" id="appsecret" name ="appsecret"  maxlength="300" size="15" value=""  > 
						</li>
						<li><span>signSecurity：</span>
	 						<input type ="text" id="signSecurity" name ="signSecurity"  maxlength="300" size="15" value=""  > 
						</li>
						<li><span>Appkey：</span>
	 						<input type ="text" id="appkey" name ="appkey"  maxlength="300" size="15" value=""  > 
						</li>
						<li><span>调用方法：</span>
	 						<input type ="text" id="method" name ="method"  maxlength="300" size="15" value=""  > 
						</li>
						<li><span>每次查询大小：</span>
