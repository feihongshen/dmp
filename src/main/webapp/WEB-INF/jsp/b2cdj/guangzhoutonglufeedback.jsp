<%@page import="cn.explink.b2c.gztlfeedback.GztlFeedback"%>
<%@page import="cn.explink.util.StringUtil"%>
<%@page import="cn.explink.enumutil.ReasonTypeEnum"%>
<%@page import="cn.explink.b2c.gztlfeedback.*"%>
<%@page import="cn.explink.domain.Branch"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
	GztlFeedback gztl = (GztlFeedback)request.getAttribute("gztlFeedbackObject");
...
<div id="box_contant">
	...
	<div id="box_top_bg"></div>
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>广州通路反馈接口设置</h1>
		<form id="smile_save_Form" name="smile_save_Form"  onSubmit="if(check_liebo()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/gztlfeedback/saveGztlFeedback/${joint_num}" method="post">
		<div id="box_form">
				<ul>
					<%if(gztl != null){ %>
