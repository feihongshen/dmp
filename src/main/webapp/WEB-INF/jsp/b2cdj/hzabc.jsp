...
<%@page import="cn.explink.b2c.hzabc.*"%>
<%@page import="cn.explink.domain.Branch"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
HangZhouABC gzabc = (HangZhouABC)request.getAttribute("hzabcObject");
...
<div id="box_contant">
	...
	<div id="box_top_bg"></div>
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>杭州ABC接口设置</h1>
		<form id="smile_save_Form" name="smile_save_Form"  onSubmit="if(check_liebo()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/hzabc/save/${joint_num}" method="post">
		<div id="box_form">
				<ul>
					<%if(gzabc != null){ %>
