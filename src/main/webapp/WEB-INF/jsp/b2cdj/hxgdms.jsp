...
<%@page import="cn.explink.b2c.hxgdms.*"%>
<%@page import="cn.explink.domain.Branch"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
Hxgdms smile = (Hxgdms)request.getAttribute("hxgdmsObject");
...
<div id="box_contant">
	...
	<div id="box_top_bg"></div>
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>好享购DMS对接设置</h1>
		<form id="smile_save_Form" name="smile_save_Form"  onSubmit="if(check_liebo()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/hxgdms/save/${joint_num}" method="post">
		<div id="box_form">
				<ul>
					<%if(smile != null){ %>
						<li><span>配送公司标识：</span>
	 						<input type ="text" id="dcode" name ="dcode"  maxlength="300"  value="<%=smile.getDcode()%>"  size="15" > 
						</li>
						<li><span>接收URL：</span>
						...
						<li><span>客服电话：</span>
	 						<input type ="text" id="deleServerMobile" name ="deleServerMobile"  maxlength="300"  value="<%=smile.getDeleServerMobile()%>"  size="15" > 
						</li>
					...
					<%}else{ %>
						...
						<li><span>在配送公司中id：</span>
					     ...
					     <li><span>客服电话：</span>
	 						<input type ="text" id="deleServerMobile" name ="deleServerMobile"  maxlength="300"  value=""  size="15" > 
						</li>
						<li><span>订单导入库房：</span>
							<select name="warehouseid">
								<option value="0">请选择库房</option>
