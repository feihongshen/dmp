...
<form id="searchForm" action ="<%=request.getContextPath()%>/editcwb/editChongZhiShenHeZhuangTai" method = "post">
	...
	<tr>
 	...
 	<tr>
		<td colspan="3" align="center">
 			<input type="submit" class="buttonnew"  value="确认提交重置审核状态" />　<input type="button" class="buttonnew"  onclick="location.href='<%=request.getContextPath()%>/editcwb/start'"  value="返回" />
		</td>
