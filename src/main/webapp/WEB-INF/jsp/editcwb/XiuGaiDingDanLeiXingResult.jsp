	...
	<tr class="font_1" height="30" style="background-color: rgb(243, 243, 243); ">
 	...
 	<tr>
		<td align="center" valign="middle" bgcolor="#EEF6FF"><strong><%=ec.getDs().getCwb() %></strong></td>
 		...
 		<td align="center" valign="middle" bgcolor="#EEF6FF"><%=CwbOrderTypeIdEnum.getByValue(ec.getNew_cwbordertypeid()).getText() %></td>
 		<td align="center" valign="middle" bgcolor="#EEF6FF"><%=DeliveryStateEnum.getByValue((int)ec.getNew_deliverystate()).getText() %></td>
 	</tr>
 	<%}} %>
	<tr>
