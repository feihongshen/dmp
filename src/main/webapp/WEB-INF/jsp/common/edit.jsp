	...
	<div id="box_in_bg">
		...
		<div id="box_form">
				<ul>
				    ...
				    <li><span>最大查询数量：</span><input type ="text" id ="pageSize" name ="pageSize" value="${common.pageSize}" size=15 maxlength="3"/></li>
				    <li><span>失败重发次数：</span><input type ="text" id ="loopcount" name ="loopcount" value="${common.loopcount}"  size=15 maxlength="3"/></li>
					<li><span>密钥：</span><input type ="text" id ="private_key" name ="private_key"   value="${common.private_key}" maxlength="100"/></li>
					<li><span>是否异步回传：</span>
					...
					<li><span>异步回传URL：</span><input type ="text" id ="feedback_url" name ="feedback_url" value="${common.feedback_url}"  maxlength="100"/></li>
					<li><span>是否开启对接：</span>
					...
					<li><span>查单电话：</span><input type ="text" id ="phone" name ="phone"  value ="${common.phone}"  maxlength="30"/></li>
