...
<div id="box_contant">
	...
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>中转入库（包）</h1>
		<div id="box_form2">
				<ul>
					<li>
					...
					<li>
						<span>包&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
						<input type="text" id="baleno" name="baleno" class="inputtext_2" value="" maxlength="50" onKeyDown='if(event.keyCode==13&&$(this).val().length>0){changeimport("<%=request.getContextPath()%>",$("#scancwb").val(),$("#driverid").val(),$("#responsebatchno").val(),$("#baleno").val(),$("#sysintowarhouse").val());}'/>
