...
$(function(){uploadFormInitAddhh('<%=request.getParameter("fromAction") %>','<%=request.getContextPath()%>');});
</script>
</head>
<body  style="position:relative">
<label id="swfupload-control">
<div style="position:absolute; z-index:9; left:0; top:0px; bottom:0px">
<input type="text" id="wavText" name="wavText" style="border: solid 1px;  background-color: #FFFFFF;" disabled="disabled"/>
</div>
