			...
			<table width="800" border="0" cellspacing="0" cellpadding="0" id="chatlist_alertbox">
				<tr>
					<td width="600" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="10" class="table_2" style="height:280px">
						...
						<tr class="font_1">
						<td align="left" valign="top">
						货物扣罚金额<font color="red">*</font>:<input type="text" id="cwbgoodprice" name="cwbgoodprice" class="input_text1" style="height:15px;width: 120px;" onkeyup="alculateSumprice(this,'cwbqitaprice','punishprice');"/>
						&nbsp;&nbsp;其它扣罚金额<font color="red">*</font>:<input type="text" id="cwbqitaprice" name="cwbqitaprice" onkeyup="alculateSumprice(this,'cwbgoodprice','punishprice');" class="input_text1" style="height:15px;width: 120px;" onfocus="javascript:if(this.value=='0.00') this.value=''" onblur="javascript:if(this.value=='') this.value='0.00'" value="0.00" />
