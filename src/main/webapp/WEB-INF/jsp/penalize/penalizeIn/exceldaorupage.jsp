...
<div id="box_bg"></div>
	...
	<div id="box_in_bg" style="overflow: scroll;width: 800px;height: 380px;">
			...
			<tr class="font_1">
				<td  align="left" valign="top">
				 <div class="right_title"  >
				 	<a id="Sto1" href="javascript:punishExcelImportSuccess('emaildate','<%=request.getContextPath() %>','appendhtmlid4');">
						成功(
				<label id="successCount111" style="font-size:18;font-weight: bold;color:red;">0</label>
							)</a> 
					<a id="Sto" href="javascript:punishExcelImport('emaildate','<%=request.getContextPath() %>','appendhtmlid4');">
