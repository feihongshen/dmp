...
<%
	List<CwbOrder> weifandanrukulist = (List<CwbOrder>)request.getAttribute("weifandanrukulist");
...
var flag="<%=flag%>";
	$(function(){
		...
		if(flag==1){
			$("#table_weiruku").addClass("light");
			$(".tabbox li").eq(0).show().siblings().hide();
		}else{
			$("#table_yiruku").addClass("light");
	 ...
	 * 返单入库扫描
	 */
	function submitcwbreturnCwbssintowarhouse(scancwb) {
		if (scancwb.length > 0) {
			$.ajax({
				type : "POST",
				url : "<%=request.getContextPath()%>/returnCwbs/cwbreturnCwbsintowarhouse/" + scancwb,
				dataType : "json",
				success : function(data) {
					$("#scancwb").val("");
					...
					if(data.statuscode=="000000"){
						...
						successcwbnum=parseInt(successcwbnum)+1;
						$("#successcwbnum").html(successcwbnum);
					}else {
...
<div class="saomiao_box2">
	...
	<div class="saomiao_topnum2">
		<dl class="blue">
			<dt>今日返单待入库</dt>
			<dd style="cursor:pointer" onclick="tabView('table_weiruku')" id="rukukucundanshu"></dd>
		</dl>
	...
	<div class="saomiao_info2">
		<div class="saomiao_inbox2">
			...
			<div class="saomiao_inwrith2">
				<div class="saomiao_left2">
					<p><span>订单号：</span>
						<input type="text" class="saomiao_inputtxt" id="scancwb" name="scancwb" value="" onKeyDown='if(event.keyCode==13&&$(this).val().length>0){submitcwbreturnCwbssintowarhouse($(this).val());}'/>
					</p>
				</div>
		...
		<div>
			<div class="saomiao_tab2">
				...
				<ul>
					<li><a id="table_weiruku" href="#">返单待入库</a></li>
					<li><a id="table_yiruku" href="#">已返单</a></li>
								...
								<td width="10%" height="26" align="left" valign="top">
									...
									<div style="height: 160px; overflow-y: scroll">
										<table id="weirukuTable" width="100%" border="0" cellspacing="1" cellpadding="2"
											class="table_2">
											<%for(CwbOrder co : weifandanrukulist){ %>
								...
								<td width="10%" height="26" align="left" valign="top">
									...
									<div style="height: 160px; overflow-y: scroll">
										...
										<table id="successTable" width="100%" border="0" cellspacing="1" cellpadding="2"
											class="table_2">
											<%for(CwbOrder co : yifandanrukulist){ %>
											<tr id="TR<%=co.getCwb() %>" cwb="<%=co.getCwb() %>" customerid="<%=co.getCustomerid() %>">
												<td width="120" align="center"><%=co.getCwb() %></td>
												<td width="100" align="center"><%for(Customer c:customerlist){if(c.getCustomerid()==co.getCustomerid()){out.print(c.getCustomername());break;}} %></td>
