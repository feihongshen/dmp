...
<div class="right_box">
	...
	<input type="hidden" name="baleid" value="<%=request.getAttribute("baleid")==null?"0":request.getAttribute("baleid")%>" >
	<input type="hidden" id="begin" name="page" value="0" >
	<input type="hidden" id="count1" name="count" value="0" >
	
	</form>
	<form id="searchForm1" action ="<%=request.getContextPath()%>/percent/<%=request.getAttribute("baleid")==null?"0":request.getAttribute("baleid")%>/show/1" method = "post">
	<input type="hidden" name="baleid" value="<%=request.getAttribute("baleid")==null?"0":request.getAttribute("baleid")%>" >
	</form>
	</div>
	...
	<form  id="searchForm" action="<%=request.getContextPath()%>/bale/show/<%=request.getAttribute("baleid")%>/1">
	</form>		
	<div class="jg_10"></div>
