...
<%
	...
	List<Branch> brancheEffectList = (List<Branch>)request.getAttribute("brancheEffectList");
...
/* 	$("#realname", parent.document).blur(function(event){
	...
	$("#branchid", parent.document).change(function(event){
		window.parent.crossCapablePDA();
	});
	$("#roleid", parent.document).change(function(event){
		window.parent.crossCapablePDA();
	});
