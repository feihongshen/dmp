...
<div id="box_contant" >
	...
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>问题件回复详情</h1>
		<form method="post" onSubmit="if(check_describe()){submitSaveFormAndCloseBox(this);}return false;" action="<%=request.getContextPath()%>/abnormalOrder/SubmitReplyabnormal/<%=abnormalOrder.getId() %>">
