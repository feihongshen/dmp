...
<div id="box_contant">
	...
	<div id="box_in_bg">
		...
		<form method="post" id="form1" onSubmit="if(check_describe()){submitSaveFormAndCloseBox(this);}return false;" action="<%=request.getContextPath()%>/abnormalOrder/SubmitHandleabnormal/<%=abnormalOrder.getId() %>" enctype="multipart/form-data">
					...
					<td width="600" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="10" class="table_2" style="height:280px">
						...
						<tr class="font_1">
							...
							&nbsp;&nbsp;问题件描述：<strong><%=abnormalOrder.getDescribe() %></strong>
								&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);">附件</a>&nbsp;&nbsp;<a href="javascript:void(0);">更多附件</a>
							</td>
			...
			<div align="center">
				...
				<%}}
				 ...
				 <input type="hidden" value="0" name="isfind"/>
