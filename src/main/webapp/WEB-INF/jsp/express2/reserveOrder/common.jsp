...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/dmp40/plug-in/My97DatePicker/skin/WdatePicker.css">
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/dmp40/plug-in/jquery/jquery-autocomplete/jquery.autocomplete.css" type="text/css">
...
<link href="<%=request.getContextPath()%>/dmp40/plug-in/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css">
...
<script src="<%=request.getContextPath()%>/js/express2/reserveOrder/reserveOrderQuery.js" type="text/javascript"></script>