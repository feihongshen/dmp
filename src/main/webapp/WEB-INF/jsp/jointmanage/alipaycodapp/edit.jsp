...
<%@page import="cn.explink.pos.alipayCodApp.*"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
AliPayCodApp alipay = (AliPayCodApp)request.getAttribute("alipaycodapplist");
%>
...
<div id="box_contant">
	...
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>支付宝CODAPP对接设置</h1>
		<form id="alipay_save_Form" name="alipay_save_Form"  onSubmit="submitSaveForm(this);return false;" action="<%=request.getContextPath()%>/alipaycodapp/save/${joint_num}" method="post">
		<div id="box_form">
				<ul>
					
					<li><span>合作者身份ID：</span>
						<input type ="text" id="partner" name ="partner" value ="<%=StringUtil.nullConvertToEmptyString(alipay.getPartner()) %>" maxlength="30"  >
					</li>
					<li><span>编码方式：</span>
