...
<div class="right_box">
	...
	<td>
	 退货库是否入库
			<select name ="istuihuozhanruku" id ="istuihuozhanruku" class="select1">
	...
	<form action="<%=request.getContextPath()%>/datastatistics/tuihuoexportExcle" method="post" id="searchForm2">
		<input type="hidden" name="sign" id="sign" value="tuihuochuzhan"/>
		...
		<input type="hidden" name="tuihuotype" value="1"/>
