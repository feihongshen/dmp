...
<%
List<CwbOrderView> orderlist = request.getAttribute("orderlist")==null?new ArrayList<CwbOrderView>():(List<CwbOrderView>)request.getAttribute("orderlist");
...
<div class="right_box">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
	   <tr class="font_1">
		...
		<%if(orderlist!=null) for(CwbOrderView c : orderlist){ %>
			<tr bgcolor="#FF3300">
