 ...
 function pagerFilter(data){
	...
	return data;
 	...
 	function printEmsLabel(cwbOrder){
		...
		LODOP.ADD_PRINT_TEXT(81,44,150,20, "徐得谱");
		LODOP.ADD_PRINT_TEXT(81,159,150,20, "027-82668066");
		LODOP.ADD_PRINT_TEXT(108,44,150,20, "武汉飞远");
		LODOP.ADD_PRINT_TEXT(108,218,150,20, "42010301326000");
		LODOP.ADD_PRINT_TEXT(131,44,150,20, "武汉市");
		LODOP.ADD_PRINT_TEXT(154,44,150,20, "唯品的订单号");
		LODOP.ADD_PRINT_TEXT(191,44,150,20, cwbOrder.consigneename);
		LODOP.ADD_PRINT_TEXT(191,159,150,20, cwbOrder.consigneemobile);
		LODOP.ADD_PRINT_TEXT(239,44,300,20, cwbOrder.consigneeaddress);
		LODOP.PRINT();
	}
