 ...
 function pagerFilter(data){
	...
	return data;
 	...
 	function printEmsLabel(cwbOrder){
		...
		LODOP.ADD_PRINT_TEXT(88,44,150,20, "武汉飞远");
		LODOP.ADD_PRINT_TEXT(88,279,150,20, "42010301326000");
		LODOP.ADD_PRINT_TEXT(111,44,150,20, "武汉市");
		LODOP.ADD_PRINT_TEXT(134,44,150,20, "唯品的订单号");
