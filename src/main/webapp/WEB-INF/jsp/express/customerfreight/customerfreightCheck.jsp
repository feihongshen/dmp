...
<!--查询  -->
<div>
	<div id="dlgQueryBox" class="easyui-dialog" style="width: 750px; height: 200px; top:100px;left:100px; padding: 10px 20px;z-index:400px;" closed="true" buttons="#btnsOfExpressQuery">
		<form id="queryBoxItemForm" method="post">
			<table>
				<tr>
					<td><label>账单编号</label></td>
					<td><input id="billNo" name="billNo" class="inp03"></input></td>
					<td width="50px;"></td>
					<td><label>账单状态</label></td>
					<td>
				...
				<tr>
					...
					<td>
						<select id="customerId" name="customerId" class="sel_02">
							<option value=""></option>
						</select>
					</td>
					<td width="50px;"></td>
...
<div>
	<div id="dlgAddBox" class="easyui-dialog" style="width: 1024px; height: 260px; top:100px;left:100px; padding: 10px 20px;z-index:400px;" closed="true" buttons="#btnsOfExpressEdit">
		...
		<form id="addForm" action="" method="post" >
			<input type="hidden" id="payMethod4Create" name="payMethod4Create" value="1"></input>
			<div style="margin-top: 20px;">
				<table border="0px;">
					<tr>
						...
						<td class="medtd" align="right">客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户</td>
						<td class="maxtd">
							<select id="customerId4Create" value="customerId4Create" class="sel_01">
							</select>
						</td>
						
						<td class="mintd"></td>
						
						<td class="medtd" align="right">付款方式:</td>
						<td class="medtd"><span>月结</span></td>
					</tr>
					<tr style="height: 10px;"></tr>
					<tr>
						<td class="maxtd" align="right" >揽件入站截止日期</td>
						<td class="maxtd" >
					...
					<tr>
						...
						<td colspan="7">
							<textarea rows="4" cols="90" id="remark4Create" name="remark4Create"></textarea>
						</td>
					</tr>
				</table>
			</div>
...
<div class="iframe_bottom"> 
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
		<tr>
			...
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Customer/1');$('#queryCondition').submit();" >第一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Customer/${page_obj.previous<1 ? 1 : page_obj.previous }');$('#queryCondition').submit();">上一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Customer/${page_obj.next<1 ? 1 : page_obj.next }');$('#queryCondition').submit();" >下一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Customer/${page_obj.maxpage<1 ? 1 : page_obj.maxpage }');$('#queryCondition').submit();" >最后一页</a>
...
<script src="<%=request.getContextPath()%>/js/express/customerfreight/customerfreightCheck.js" type="text/javascript"></script>
