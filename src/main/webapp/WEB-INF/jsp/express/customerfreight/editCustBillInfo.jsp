...
<div>
	...
	<table>
		<tr>
			...
			<td class="maxtd" align="right">揽件入站截止日期${expressBill.dealLineTimeName }</td>
			<td><input disabled="disabled" id="" name="" value="${expressBill.dealLineTime }" /></td>
		</tr>
		<tr>
			<td class="maxtd" align="right">客户</td>
			<td><input disabled="disabled" id="" name="" value="${expressBill.customerName }" /></td>
