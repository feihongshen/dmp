...
<body>
	...
	<div align="center" style="margin-bottom: 10px;">
		<input type="button" class="input_button1" id="generateBill" value="生成账单"  onclick="generateBillOpe4AcrossRece();"/> 
	...
	<input type="hidden" id="receProvince4PreScan" value="${createParams.receProvince4Create }"></input><!-- 应收省份 -->
	<input type="hidden" id="payProvince4PreScan" value="${createParams.payProvince4Create }"></input><!-- 应付省份 -->
