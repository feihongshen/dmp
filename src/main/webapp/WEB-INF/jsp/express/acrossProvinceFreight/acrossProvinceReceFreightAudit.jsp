...
<script src="<%=request.getContextPath()%>/js/express/accrossReceFreight/accrossProvinceReceFreightAudit.js" type="text/javascript"></script>
</head>
	...
	<div class="iframe_bottom"> 
		<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
			<tr>
				...
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossProvinceReceFreightAudit/toAcrossProvinceReceFreightAudit/1');$('#queryCondition').submit();" >第一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossProvinceReceFreightAudit/toAcrossProvinceReceFreightAudit/${page_obj.previous<1 ? 1 : page_obj.previous }');$('#queryCondition').submit();">上一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossProvinceReceFreightAudit/toAcrossProvinceReceFreightAudit/${page_obj.next<1 ? 1 : page_obj.next }');$('#queryCondition').submit();" >下一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossProvinceReceFreightAudit/toAcrossProvinceReceFreightAudit/${page_obj.maxpage<1 ? 1 : page_obj.maxpage }');$('#queryCondition').submit();" >最后一页</a>
	...
	<!-- 点击查询按钮的查询条件弹出框 -->
 	<div>
 		<div id="QueryExpressBox" class="easyui-dialog" style="width: 800px; height: 250px; top:200px;left:200px; padding: 10px 20px;z-index:1000px;" closed="true" buttons="#dlg2Match">
			<form id="queryCondition" method="post" action="<%=request.getContextPath()%>/acrossProvinceReceFreightAudit/toAcrossProvinceReceFreightAudit/1">
...
<form id="exportForm" method="post" action="<%=request.getContextPath()%>/acrossProvinceReceFreightAudit/exportBill">
