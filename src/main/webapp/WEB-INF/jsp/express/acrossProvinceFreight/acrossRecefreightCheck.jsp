		...
		<form id="queryBoxItemForm" method="post">
			<table>
				...
				<tr>
					<td>应付省份</td>
					<td>
						<select id="payableProvinceId" name="payableProvinceId" class="sel_02">
						</select>
					</td>
					<td width="50px;"></td>
					<td>排序</td>
...
<div>
	<div id="dlgAddBox" class="easyui-dialog" style="width: 1024px; height: 260px; top:100px;left:100px; padding: 10px 20px;z-index:400px;" closed="true" buttons="#btnsOfExpressEdit">
		...
		<form id="addForm" action="" method="post" >
			...
			<!-- 应收省份id -->
			<input type="hidden" id="receProvince4Create" name="receProvince4Create" value="${userInfo.provinceId }"/>
			<div style="margin-top: 10px;">
				<table border="0px;">
					<tr>
						...
						<td class="maxtd">
							<input value="${userInfo.provinceName }" class="inp01" disabled="disabled" id="receProvince4CreateName" name="receProvince4CreateName" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="maxtd">
							<select id="payProvince4Create" value="payProvince4Create" class="sel_01">
...
<div class="iframe_bottom"> 
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
		<tr>
			...
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossReceFreightCheck/billList4AcrossRece/1');$('#queryCondition').submit();" >第一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossReceFreightCheck/billList4AcrossRece/${page_obj.previous<1 ? 1 : page_obj.previous }');$('#queryCondition').submit();">上一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossReceFreightCheck/billList4AcrossRece/${page_obj.next<1 ? 1 : page_obj.next }');$('#queryCondition').submit();" >下一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/acrossReceFreightCheck/billList4AcrossRece/${page_obj.maxpage<1 ? 1 : page_obj.maxpage }');$('#queryCondition').submit();" >最后一页</a>
...
<script src="<%=request.getContextPath()%>/js/express/accrossReceFreight/acrossRecefreightCheck.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/js/express/accrossReceFreight/preAcrossReceScanList.js" type="text/javascript"></script>
</body>
