		...
		<table style="width: 100%">
		    <tr>
			    <td>
				    ...
				    <input class="input_button2" type="button"  id="exportButton" onclick="exportClick()" value="导出"/>
		    	</td>
		    </tr>
		</table>
...
<input type="hidden" id="fatherURL" value="<%=request.getContextPath()%>/transProvincialAuditReconciliationController/" /> 
<input type="hidden" id="UncleURL" value="<%=request.getContextPath()%>/transProvincialReceivedReconciliationController/" /> 
...
function exportClick(){
	$("#page").val($("#selectPg").val());
	$("#provincereceivablecodbillid").val($("#updateBox_id_id").val());
	var url = $("#fatherURL").val()+"exportBill";
