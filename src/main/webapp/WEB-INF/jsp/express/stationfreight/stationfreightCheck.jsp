		...
		<form id="queryBoxItemForm" method="post">
			<table>
				...
				<tr>
					<td>站点</td>
					<td>
						<select id="branchId" name="branchId" class="sel_02">
							<option value=""></option>
						</select>
					</td>
					<td width="50px;"></td>
...
<!--编辑  -->
<div>
	<div id="dlgEditBox" class="easyui-dialog" style="width: 880px; height: 650px; top:100px;left:100px; padding: 10px 20px;z-index:400px;" closed="true" buttons="#btnsOfExpressEdit">
...
<!--新增  -->
<div>
	<div id="dlgAddBox" class="easyui-dialog" style="width: 840px; height: 260px; top:120px;left:150px; padding: 10px 20px;z-index:400px;" closed="true" buttons="#btnsOfExpressEdit">
		...
		<form id="addForm" action="" method="post" >
			<div style="margin-top: 10px;">
				<table border="0px;">
					<tr>
						<td class="maxtd" align="right">账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编&nbsp;&nbsp;&nbsp;&nbsp;号</td>
						<td class="maxtd"><input value="jjyy1234" class="inp01" disabled="disabled" id="billNo4Create" name="billNo4Create"/></td>
						
						<td class="medtd" align="right">站点</td>
						<td class="maxtd">
							<select id="branchId4Create" value="branchId4Create" class="sel_01">
								<option value=""></option>
					...
					<tr>
						<td class="maxtd" align="right" >
							<select id="timeItem" value="timeItem" style="height: 25px;">
								<option value="1">揽件入站截止日期</option>
								<option value="2">签收截止日期</option>
							</select>
						</td>
						<td class="maxtd" >
						...
						<td class="maxtd" align="right">付款方式:</td>
						<td class="maxtd">
							<select id="payMethod4Create" value="payMethod4Create" class="sel_01">
					...
					<tr style="height: 10px;"></tr>
					<tr>
						<td width="200px;" valign="top" align="right">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</td>
						<td colspan="3">
							<textarea rows="4" cols="100" id="remark4Create" name="remark4Create"></textarea>
						</td>
					</tr>
				</table>
			</div>
...
<!--预览界面  -->
<div>
	<div id="dlgPreScanBox4Cust" class="easyui-dialog" style="width: 880px; height: 550px; top:100px;left:100px; padding: 10px 20px;z-index:400px;" closed="true" >
		<div id="preScanContainer4Cust"></div>
	</div>
</div>	
...
<div class="iframe_bottom"> 
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
		<tr>
			...
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Station/1');$('#queryCondition').submit();" >第一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Station/${page_obj.previous<1 ? 1 : page_obj.previous }');$('#queryCondition').submit();">上一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Station/${page_obj.next<1 ? 1 : page_obj.next }');$('#queryCondition').submit();" >下一页</a>　
			<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/customerFreightCheck/billList4Station/${page_obj.maxpage<1 ? 1 : page_obj.maxpage }');$('#queryCondition').submit();" >最后一页</a>
...
<script src="<%=request.getContextPath()%>/js/express/stationfreight/stationfreightCheck.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/js/express/stationfreight/preScanList.js" type="text/javascript"></script>
</body>
