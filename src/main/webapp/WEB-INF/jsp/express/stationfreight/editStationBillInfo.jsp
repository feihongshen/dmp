...
<div>
	...
	<table>
		<tr>
			...
			<td class="maxtd" align="right">站点</td>
			<td><input disabled="disabled" id="" name="" value="${expressBill.branchName }" /></td>
		</tr>
		<tr>
			<td class="maxtd" align="right">付款方式</td>
			<td><input disabled="disabled" id="" name="" value="${expressBill.payMethod }" /></td>
