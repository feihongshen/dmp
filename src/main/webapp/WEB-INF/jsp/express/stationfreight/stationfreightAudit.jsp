...
<div class="right_box">
	<div class="inputselect_box">
			<table style="width: 100%">
			    <tr>
				    <td>
					    <input class="input_button2" type="button" id="confirm_btn" onclick="edit('stationAuditTable');" value="查看/修改"/>
	...
	<div class="jg_10"></div>
		<div class="right_title">
			<div style="overflow: auto;">
				<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2"  id="stationAuditTable">
					<tr>
	...
	<div class="iframe_bottom"> 
		<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
			<tr>
				...
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/stationFreightAudit/toStationFreightAudit/1');$('#queryCondition').submit();" >第一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/stationFreightAudit/toStationFreightAudit/${page_obj.previous<1 ? 1 : page_obj.previous }');$('#queryCondition').submit();">上一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/stationFreightAudit/toStationFreightAudit/${page_obj.next<1 ? 1 : page_obj.next }');$('#queryCondition').submit();" >下一页</a>　
				<a href="javascript:$('#queryCondition').attr('action','${pageContext.request.contextPath}/stationFreightAudit/toStationFreightAudit/${page_obj.maxpage<1 ? 1 : page_obj.maxpage }');$('#queryCondition').submit();" >最后一页</a>
	...
	<!-- 点击查询按钮的查询条件弹出框 -->
 	<div>
 		<div id="QueryExpressBox" class="easyui-dialog" style="width: 800px; height: 250px; top:200px;left:200px; padding: 10px 20px;z-index:1000px;" closed="true" buttons="#dlg2Match">
			<form id="queryCondition" method="post" action="<%=request.getContextPath()%>/stationFreightAudit/toStationFreightAudit/1">
			<div style="margin-left: 20px;" id="dispatchItem">
				<table>
					...
					<tr>
						<td>站点</td>
						<td>
							<select id="branchId" name="branchId" style="width:210px">
							</select>
						</td>
						<td>排序</td>
						<td>
			...
			<div style="margin-left: 20px;" id="dispatchItem">
				<div class="right_box">
							...
							<table style="width: 100%">
						 	...
						 	<table style="height: 200px;">
								<tr>
									...
									<td>站点</td>
									<td><input id="branchNameEdit" disabled=true/></td>
								</tr>
								<tr>
									<td>付款方式</td>
									<td><input id="payMethodEdit" disabled=true/></td>
									<td>运费金额合计</td>
					...
					<div class="right_title" style="width: 97%;">
						<div style="overflow: auto;">
							<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2"  id="stationAuditEdit" style="margin-top: 199px;">
								<tr id="firstTR">
...
<div>
	...
	<input type="hidden" id="branchIdValue" value="${expressFreightAuditBillVO.branchId}"/>
...
<script src="<%=request.getContextPath()%>/js/express/stationfreight/stationFreightAudit.js" type="text/javascript"></script>
