...
$.ajax({
	url:"<%=request.getContextPath()%>/sms/sendCwb",//后台处理程序
	type:"POST",//数据发送方式 
	data:params,//参数
...
<div class="right_box">
	...
	<div class="uc_midbg">
		<ul>
			...
			<li><a href="#" class="light">订单号</a></li>
		...
		<li><div class="right_title">
	  	...
	  	<table width="100%" border="0" cellspacing="0" cellpadding="5" class="table_2">
	  		<tr>
	  			...
	  			<td align="left"><textarea name="mobiles" cols="40" rows="5" id="mobilesID" onkeyup="onblurcwb();" ></textarea>多个订单号用回车间隔 ，已输入的订单数（<font color="red" id="cwbcount">0</font>）</td>
  			</tr>
	  		<tr>
