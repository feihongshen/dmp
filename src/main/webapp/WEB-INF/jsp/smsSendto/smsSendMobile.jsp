...
$.ajax({
	url:"<%=request.getContextPath()%>/sms/sendMobile",//后台处理程序
	type:"POST",//数据发送方式 
	data:params,//参数
...
<div class="right_box">
	...
	<div class="uc_midbg">
		<ul>
			<li><a href="<%=request.getContextPath()%>/sms/viewrole" >公司内部</a></li>
			<li><a href="<%=request.getContextPath()%>/sms/viewcwb">订单号</a></li>
			<li><a href="<%=request.getContextPath()%>/sms/viewbranch">站点区域</a></li>
			<li><a href="#"  class="light">手机号</a></li>
		</ul>
	</div>
	<div class="tabbox">
	  
		<li><div class="right_title">
	  	<form name="form1" method="post" action="" id="sendForm">
	  	<table width="100%" border="0" cellspacing="0" cellpadding="5" class="table_2">
	  		<tr>
	  			<td width="60" align="left">手机号：</td>
	  			<td align="left"><textarea name="mobiles" cols="40" rows="5" id="mobilesID" onkeyup="onblurcwb();" ></textarea>多个手机号用回车间隔 ，已输入的手机号数（<font color="red" id="cwbcount">0</font>）</td>
  			</tr>
	  		<tr>
