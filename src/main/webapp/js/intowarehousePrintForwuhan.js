			...
			success : function(data) {
				if(data.statuscode=="000000"){
					...
					var printHtml = "<table border='0' style=\"width: 35mm; height: 30mm; display: table;\" cellspacing=\"0\" valign=\"TOP\" cellpadding=\"0\">"+
	                                  ...
	                                  "<tr><td style='word-break: keep-all;white-space:nowrap;'><div style=\"font-family:黑体; font:bolder;font-size:4mm;font-weight:4mm;\" align=\"center\">" + branchname+ "</div></td></tr>"+
...
function CreateOneFormPageForwuhan(scancwb,printHtml){
	...
	//LODOP_wuhan.NEWPAGE();
	LODOP_wuhan.PRINT_INIT("分拣码打印");
	//LODOP_wuhan.SET_PRINT_STYLE("Bold",1);
	//LODOP_wuhan.ADD_PRINT_TABLE(0,0,200,150,printHtml);
	LODOP_wuhan.NewPage();
	LODOP_wuhan.ADD_PRINT_HTM("0mm","0mm","RightMargin:0mm","BottomMargin:0mm", '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><body>' + printHtml + '</body></html>');
};
/**
 * 直接打印方法
 * @param scancwb
