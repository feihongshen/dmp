...
if (jQuery) (function ($)
{
    ...
    $.extend($.fn, {
        expMultiSelect: function (o, callback, hideCallback)
        {
            // Default options
            if (!o) var o = {};
            ...
            $(this).each(function ()
            {
                ...
                }).click(function ()
                {
                    ...
                    {
                        $(this).expMultiSelectOptionsHide();
                        if (hideCallback)
                        {
                            hideCallback();
                        }
                    ...
                    {
                        $(this).expMultiSelectOptionsShow(hideCallback);
                    }
                    return false;
                });
                ...
                {
                    $(this).parent().parent().expMultiSelectUpdateSelected(o);
                ...
                {
                    $(this).expMultiSelectUpdateSelected(o);
                ...
                $(select).next('.multiSelect').keydown(function (e)
                {
                    ...
                    if ($(this).next('.multiSelectOptions').is(':visible'))
                    {
                        ...
                        if (e.keyCode == 40)
                        {
                            ...
                            $(this).expMultiSelectAdjustViewport($(this));
                        ...
                        if (e.keyCode == 13 || e.keyCode == 32)
                        {
                            ...
                            if ($(this).next('.multiSelectOptions').find('LABEL.hover INPUT:checkbox').hasClass('selectAll'))
                            {
                                ...
                                $(this).next('.multiSelectOptions').expMultiSelectUpdateSelected(o);
        ...
        // Hide the dropdown
        expMultiSelectOptionsHide: function ()
        {
            $(this).removeClass('active').removeClass('focus').next('.multiSelectOptions').hide();
        },

        // Show the dropdown
        expMultiSelectOptionsShow: function (hideCallback)
        {
            // Hide any open option boxes
            $('.multiSelect').expMultiSelectOptionsHide();
            ...
            }, function ()
            {
                ...
                {
                    jQuery(multiSelectCurrent).expMultiSelectOptionsHide();

                    var $select = $('.multiSelect').children('INPUT.multiSelect_txt');
                    if (hideCallback)
                    {
                        hideCallback($($select[0]).val());
                    }
                    $(multiSelectCurrent).unbind("hover");
                    $(multiSelectCurrent).next('.multiSelectOptions').unbind("hover");
                }, 250);
            });
        ...
        expMultiSelectUpdateSelected: function (o)
        {
            var i = 0, s = '';
        ...
        expMultiSelectAdjustViewport: function (el)
        {
