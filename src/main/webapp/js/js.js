...
function addContract() {
	$("#alert_box").html('<div id="box_contant">'+
			'	<div id="box_top_bg"></div>'+
			'	<div id="box_in_bg">'+
			'		<h1><div id="close_box" onclick="closeBox()"></div>创建加盟商合同</h1>'+
			'		<div id="box_form">'+
			'			<form action="'+getPath()+'/branchContract/addBranchContract" id="addcallerForm">'+
			'		 	<table>'+
			'					<tr>'+
			'						<th align="left">编号</th>'+
			...
			'						<td><input type="text" name="branchName" value="" id="branchName" maxlength="20"/></td>'+
			...
			'						<td colspan="5">'+
			'							<a href="#" id="contractAttachment" name="contractAttachment"></a>'+
			'						</td>'+
			'					</tr>'+
			...
			'		</div>'+
			'		<div align="center">'+
			'			<input type="button" value="确认" class="button" align="center" onclick="addcaller()">'+
...
function updateContract(){
	...
	$("#alert_box").html('<div id="box_contant">'+
			...
			'		<div id="box_form">'+
			'			<form action="'+getPath()+'/branchContract/updateBranchContract" id="editcallerForm">'+
			'				<table>'+
			'					<tr>'+
			'						<th>编号</th>'+
			'						<td><input type="text" name="contractNo" value="" id="contractNo" maxlength="20"/></td>'+
			...
			'						<th>合同日期范围</th>'+
			'						<td>'+
			'							<input type="text" name="contractBeginDate" id="contractBeginDate" value="" class="input_text1"/>'+
			'							至'+
			'							<input type="text" name="contractEndDate" id="contractEndDate" value="" class="input_text1"/>'+
			'						</td>'+
			'					</tr>'+
			'					<tr>'+
			'						<th>加盟商名称</th>'+
			...
			'						<th>合同详细描述</th>'+
			'						<td colspan="5">'+
			'						<textarea style="width:100%;height:118px;margin-left:60px" name="contractDescription" id="contractDescription"></textarea>'+
			'						</td>'+
			'					</tr>'+
			'					<tr>'+
			'						<th>合同附件</th>'+
			...
			'					<tr>'+
			'						<th>押金收取日期</th>'+
			'						<td><input type="text" name="depositCollectDate" value="" id="depositCollectDate" maxlength="20"/></td>'+
			'						<th>押金收取金额</th>'+
			'						<td><input type="text" name="depositCollectAmount" value="" id="depositCollectAmount" maxlength="20"/></td>'+
			'						<th></th>'+
			'						<td></td>'+
			...
			'								<tbody>'+
			'									<tr>'+
			'										<td><input type="checkbox" name="checkAllTrs" onclick="javascript:alert();checkAllTrs();"/></td>'+
			'										<td>押金退换日期</td>'+
			'										<td>押金退还金额</td>'+
			'										<td>退款人</td>'+
			'										<td>收款人</td>'+
			...
			'					<tr>'+
			'						<td colspan="6">'+
			'							<input type="button" value="添加" class="button" align="center" onclick="addTr()"/>'+
			'							<input type="button" value="移除" class="button" align="center" onclick="deleteTr()"/>'+
			'						</td>'+
			'					</tr>'+
			'					</table>'+
			...
			'		</div>'+
			'		<div align="center">'+
			'			<input type="button" value="确认修改" class="button" align="center" onclick="updateContractData()"/>'+
...
function queryContract(){
	$("#alert_box").html('<div id="box_contant">'+
			...
			'					<tr>'+
			'						<th align="left">合同详细描述</th>'+
			'						<td><input type="text" name="contractDescription" id="contractDescription"/></td>'+
			'						<th align="left">是否有押金</th>'+
			'						<td>'+
			'							<select id ="isDeposit" name ="isDeposit">'+
	...
	$.ajax({
		...
		success : function(data) {
			if(data){
				...
				$("#editcallerForm a[name='contractAttachment']").val(data.contractAttachment);
	...
	if(list){
		for(var i=0;i<list.length;i++){
			...
			for(var j=1;j<tds.length;j++){
				...
				tds[j].textContent = trObj[tdName];
			}
		}
	}
}
function checkAllTrs(){
	//$("#depositTable input[type='checkbox'][name='checkAllTrs']")[0].children;
...
function addTr(){
	...
	tr.append(checkTd); 
	var depositReturnTimeTd = $("<td class='contractTd' name='depositReturnTime'></td>"); 
	tr.append(depositReturnTimeTd); 
	var depositReturnAmountTd = $("<td class='contractTd' name='depositReturnAmount'></td>"); 
	tr.append(depositReturnAmountTd); 
	var depositReturnPersonTd = $("<td class='contractTd' name='depositReturnPerson'></td>"); 
	tr.append(depositReturnPersonTd); 
	var depositCollectorTd = $("<td class='contractTd' name='depositCollector'></td>"); 
	tr.append(depositCollectorTd); 
	var remarkTd = $("<td class='contractTd' name='remark'></td>"); 
	tr.append(remarkTd); 
	table.append(tr);
	rowCount++;
	initBranchContract();
