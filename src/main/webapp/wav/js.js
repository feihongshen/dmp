...
//监控配送状态变化 对显示字段做相应处理
function click_podresultid(PeiSongChengGong,ShangMenTuiChengGong,ShangMenHuanChengGong,JuShou,BuFenTuiHuo,FenZhanZhiLiu,ShangMenJuTui,HuoWuDiuShi){
...
//验证字段是否正确输入
function check_deliveystate(PeiSongChengGong,ShangMenTuiChengGong,ShangMenHuanChengGong,JuShou,BuFenTuiHuo,FenZhanZhiLiu,ShangMenJuTui,HuoWuDiuShi){
	var podresultid =  parseInt($("#podresultid").val());
	if(podresultid==-1){
