...
ALTER TABLE `express_set_user`
	ADD COLUMN `lastLoginState` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '上次登录状态（1-成功，0-失败）',
	ADD COLUMN `loginFailCount` INT(1) NOT NULL DEFAULT '0' COMMENT '累计连续登录错误次数',
	ADD COLUMN `lastLoginTryTime` VARCHAR(50) NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次尝试登录时间';
