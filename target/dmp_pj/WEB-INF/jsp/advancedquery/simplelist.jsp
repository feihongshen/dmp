...
<div class="right_box">
	...
	<form action="<%=request.getContextPath()%>/advancedquery/exportExcleSimple" method="post" id="searchForm2">
	...
	<tr>
	<td class="high">代收金额总计：<font class="high" color="red"><%=request.getAttribute("sum")==null?"0.00":request.getAttribute("sum") %></font>&nbsp;元 </td>
	</tr>
	<tr>
	<td class="high">代退金额总计：<font class="high" color="red"><%=request.getAttribute("paybackfeesum")==null?"0.00":request.getAttribute("paybackfeesum") %></font>&nbsp;元 </td>
	</tr>
	</table>
	<%} %>
	</div><%} %>
