...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/swfupload/swfupload.queue.js"></script>
 ...
 $(document).ready(function() {
	 $("#btn").click(function (){
		 $('#searchForm').attr('action','<%=request.getContextPath()%>/abctest/');
		 $('#searchForm').submit();
...
<div class="menucontant">
	...
	<form  method="post" id="searchForm">
		请选择请求接口:action=<select name="action" id="action">
									...
									<option value="gzabc" >广州ABC</option>
									<option value="hzabc" >杭州ABC</option>
							  </select>
		<br><br>
		<br><input type="button" value="提交请求" id="btn" name="btn"/><br>
		请求的XML:<textarea rows="10" cols="50" name="logicdata"></textarea>
		返回的XML：<textarea rows="10" cols="50" ><%=values%></textarea><font color="red"></font>
		<br>
	</form>
