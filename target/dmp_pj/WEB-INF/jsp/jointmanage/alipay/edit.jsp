...
<%@page import="cn.explink.pos.alipay.*"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/js/jquery-1.7.1.min.js" type="text/javascript"></script>
<%
AliPay alipay = (AliPay)request.getAttribute("alipaylist");
%>
...
<div id="box_contant">
	...
	<div id="box_in_bg">
		<h1><div id="close_box" onclick="closeBox()"></div>支付宝对接设置</h1>
		<form id="alipay_save_Form" name="alipay_save_Form"  onSubmit="if(check_alipay()){submitSaveForm(this);}return false;" action="<%=request.getContextPath()%>/alipay/save/${joint_num}" method="post">
		<div id="box_form">
				<ul>
