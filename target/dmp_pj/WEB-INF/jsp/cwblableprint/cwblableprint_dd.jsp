					...
					<td>
						<table width="100%" border="1" cellspacing="0" cellpadding="5" class="table1">
							<tr>
								...
								<div style="float:right; width:200px; line-height:20px">&nbsp;<%=co.getEmaildate().substring(0, 10) %>&nbsp;叮咚
							...
							<tr>
								...
								<td colspan="2" align="center" style="padding: 1px 0;height:80">
						...
						<table width="100%" border="1" cellspacing="0" cellpadding="5" class="table2">
							...
							<tr>
								<td>客户：<%=co.getConsigneename().split(" ")[0] %>&nbsp;电话：<%=co.getConsigneemobile().length()==0?co.getConsigneephone():co.getConsigneemobile() %></td>
								<td>应收金额：<%=co.getReceivablefee() %>元</td>
							</tr>
							<tr>
								<td><p>网址：www.dingdong.cn</p>
									<p>客服电话：010-57594815</p></td>
								<td rowspan="2">保留此单包裹单底代表您已经签收并认可我们的服务，如有任何疑问可联系客服咨询。</td>
							</tr>
							<tr>
								<td>叮咚：www.dingdong.cn</td>
							</tr>
						</table>
