...
<div id="box_contant">
	...
	<div id="box_in_bg">
		...
		<div id="box_form2">
				<ul>
					<!-- <li>
	           			<div id="nowkucundanshu" style="color:red;font-weight:bold"></div>
					</li> -->
					<li><span>扫描：</span><input type="text" class="inputtext_2" id="scancwb" name="scancwb" value="" maxlength="50" onKeyDown='if(event.keyCode==13&&$(this).val().length>0){cwbscancwbbranch("<%=request.getContextPath()%>",$(this).val(),"kufang");}'/></li>
