...
<div class="right_box">
	<div class="inputselect_box">
		<form action="<%=request.getContextPath()%>/wharehourecommon/showlist" method="post" id="searchForm">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
	   ...
	   <td width="30" align="center" valign="middle" ><input type="checkbox"  id="btn1" value="-1"/></td>
		...
		<tr>
			...
			<td width="60%" align="center" valign="middle"><a href="<%=request.getContextPath()%>/wharehourecommon/show/<%=c.getCommencode() %>/1"><%=c.getId()%></a></td>
		...
		<tr valign="middle">
			<td colspan="3" align="center" valign="middle">
				<form id="updateForm"
					action="<%=request.getContextPath()%>/wharehourecommon/audit"
					method="post">
