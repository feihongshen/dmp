...
<div class="right_box">
	<div class="inputselect_box">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_1">
					<tr class="font_1">
						<td width="20%" align="center" valign="middle" bgcolor="#eef6ff">站名</td>
						<td width="20%" align="center" valign="middle" bgcolor="#eef6ff">批次号</td>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_2" id="gd_table">
					 ...
					 <tr>
					 	<%for(Branch branch:blist){if(og.getBranchid()==branch.getBranchid()){ %>
							<td width="20%" align="center" valign="middle"><%=branch.getBranchname() %></td>
					     <%}} %>
						<td width="20%" align="center" valign="middle"><%=og.getId() %></td>
						...
						<td width="20%" align="center" valign="middle" >
							<a href ="../outbillprinting_default/<%=og.getId()%>">出库交接单打印</a>
