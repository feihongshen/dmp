...
<div id="box_contant">
	...
	<div id="box_in_bg">
		...
		<form id="smsconfig_save_Form" name="smsconfig_save_Form" onSubmit="if(check_sysconfig()){submitSysconfigForm(this);}return false;" action="<%=request.getContextPath()%>/smsconfigmodel/savesmsconfig" method="post"  >
		<div id="box_form">
				<ul>
