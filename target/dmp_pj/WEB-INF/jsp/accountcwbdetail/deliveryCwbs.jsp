...
<%
	...
	long summaryid=request.getParameter("summaryid")==null?0:Long.parseLong(request.getParameter("summaryid"));
...
<div class="inputselect_box" style="top: 0px ">
	<form action="<%=request.getAttribute("page")==null?"1":request.getAttribute("page") %>" method="post" id="searchForm">
		<input type="hidden" id="flowOrderType" name="flowOrderType" value="<%=flowOrderType%>"/>
...
<form action="" method="post">
	<table width="100%" border="0" cellspacing="1" cellpadding="2" class="table_2" >
		<tr class="font_1">
			<td height="53" bgcolor="#f4f4f4">订单号</td>
		...
		<tr>
			...
			<td  class="high"><font color="red"><%=accountCwbDetail.getCash()%></font></td>
			<td  class="high"><font color="red"><%=accountCwbDetail.getPos()%></font></td>
			<td  class="high"><font color="red"><%=accountCwbDetail.getCheckfee()%></font></td>
			<td  class="high"><font color="red"><%=accountCwbDetail.getOtherfee()%></font></td>
		</tr>
	</table>
	<!--底部翻页 -->
	<div class="jg_35"></div>
...
<form action="<%=request.getContextPath() %>/accountcwbdetail/exportByDelivery" method="post" id="exportForm">
	<input type="hidden" id="flowOrderType" name="flowOrderType" value="<%=flowOrderType%>"/>
	<input type="hidden" id="summaryid" name="summaryid" value="<%=summaryid%>"/>
</form>
