...
<body style="tab-interval: 21pt;">
	...
	<tr>
		...
		<%if(printTemplate.getOpertatetype()==PrintTemplateOpertatetypeEnum.LingHuoAnDan.getValue()||printTemplate.getOpertatetype()==PrintTemplateOpertatetypeEnum.LingHuoHuiZong.getValue()){%>
			...
			<td colspan="2"><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt; font-size: 9.5000pt;">配送站点：***站<span
									style="font-size: 9.5000pt; font-family: '&amp;#23435;&amp;#20307;';">
				<o:p></o:p>
			</span> </span></td>
		<%}else{ %>
			...
			<td colspan="2"><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt;font-size: 9.5000pt;">***站<span
									style="font-size: 9.5000pt; font-family: '&amp;#23435;&amp;#20307;';">
				<o:p></o:p>
			</span> </span></td>
		<%} %>
	...
	<tr>
		...
		<td><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt;"><span
								...
								style="font-size: 10.5000pt; font-family: 'Times New Roman';">
			<o:p></o:p>
		</span></span></td>
		<td><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt;"><span
								style="mso-spacerun: 'yes'; font-size: 9.5000pt; font-family: '&amp;#23435;&amp;#20307;';">0</span><span
								style="font-size: 9.5000pt; font-family: 'Times New Roman';">
			<o:p></o:p>
		</span></span></td>
		<td><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt;"><span
		...
		<td><span class="p0" style="margin-bottom: 0pt; margin-top: 0pt;"><span
								style="mso-spacerun: 'yes'; font-size: 9.5000pt; font-family: '&amp;#23435;&amp;#20307;';">0.00元</span><span
								style="font-size: 9.5000pt; font-family: 'Times New Roman';">
			<o:p></o:p>
		</span></span></td>
		</tr>
	<tr>
		...
		<td>&nbsp;</td>
		<td style="font-size: 9.5000pt;">收货人：</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
