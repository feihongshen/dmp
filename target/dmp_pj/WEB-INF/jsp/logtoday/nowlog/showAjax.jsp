...
<%
List<CwbOrder> cwborderList = request.getAttribute("cwborderList")==null?null:(List<CwbOrder>)request.getAttribute("cwborderList");
...
<div class="right_box">
	...
	<form id="searchForm1" action ="<%=request.getContextPath()%>/logtoday/todayArrivalAjax" method = "post">
	   ...
	   <tr class="font_1">
		...
		<% for(CwbOrder c : cwborderList){ %>
				<tr bgcolor="#FF3300">
					...
					<td  align="center" valign="middle"><%=DeliveryStateEnum.getByValue(c.getDeliverystate())==null?"":DeliveryStateEnum.getByValue(c.getDeliverystate()).getText() %></td>
