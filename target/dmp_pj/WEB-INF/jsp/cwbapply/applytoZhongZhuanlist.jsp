...
<div style="background:#FFF">
	...
	<div class="inputselect_box">
		...
		<form action="<%=request.getContextPath()%>/cwbapply/exportZhongZhuanExcle" method="post" id="searchForm2">
	...
	<div style="overflow-x:scroll; width:100% " id="scroll">
		...
		<% for(CwbOrderView  c : cwbViewList){ %>
			<tr bgcolor="#FF3300">
				...
				<td  align="center" valign="middle"><%if(c.getApplyzhongzhuanishandle()==0){%>未审核<%}else if(c.getApplyzhongzhuanishandle()==1){ %>已审核<%}else{ %>客户拒审<%} %></td>
				<td  align="center" valign="middle"><%=c.getApplyzhongzhuanhandleusername() %></td>
				<td  align="center" valign="middle"><%=c.getApplyzhongzhuanhandleremark() %></td>
				<td  align="center" valign="middle"><%=c.getApplyzhongzhuanhandletime() %></td>
			 </tr>
		 <% }%>
		</table>
	</div>
